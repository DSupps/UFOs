...
## Challenge Results:
The index landing page is interactive and has the ability to filter search results by date, city, state, country, and shape. The user can choose one up to all five filters at once.
